...
public class IdentifyMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(com.sciencetogether.perecastor.mosquitomapper.R.layout.activity_identify_main);
        ...
        mSolution1 = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.antennae_button_1);
        mSolution2 = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.antennae_button_2);
        mError     = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.antennae_button_error);
