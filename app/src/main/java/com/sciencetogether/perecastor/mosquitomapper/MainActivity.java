...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sciencetogether.perecastor.mosquitomapper.R.layout.activity_main);

        mLocalise    = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.localise_button);
        mIdentify    = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.identify_button);
        mInformation = (Button) findViewById(com.sciencetogether.perecastor.mosquitomapper.R.id.information_button);
